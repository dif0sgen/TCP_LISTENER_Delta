...
namespace TCP_LISTENER_Delta.DataSetDBTableAdapters {
...
SELECT Id, Camera, Time, [1], [2], [3], [4], [5] FROM [Table] WHERE (Id = @Id)";
        ...
        public virtual int Fill(DataSetDB.TableDataTable dataTable) {
        ...
        public virtual DataSetDB.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetDB.TableDataTable dataTable = new DataSetDB.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetDB.TableDataTable dataTable) {
